      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-brand-dark/55">Arraste a comparação para ver o antes e o depois. As imagens são de trabalhos reais da JMartins.</p>
